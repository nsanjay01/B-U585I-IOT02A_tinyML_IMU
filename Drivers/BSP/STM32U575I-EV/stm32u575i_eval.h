...
/**
  * @brief STM32U575I_EVAL BSP Driver version number V1.4.1
  */
#define STM32U575I_EVAL_BSP_VERSION_MAIN   (uint32_t)(0x01U) /*!< [31:24] main version */
#define STM32U575I_EVAL_BSP_VERSION_SUB1   (uint32_t)(0x04U) /*!< [23:16] sub1 version */
#define STM32U575I_EVAL_BSP_VERSION_SUB2   (uint32_t)(0x01U) /*!< [15:8]  sub2 version */
